...
def ui_footer_status():
    return {
        ...
        "f_rate": {"type": "Text", "props": {"text": "🏃 회피 성공: {{total_evade}}회", "variant": "muted"}},
...
dino_v1 = {
    ...
    "nodes": [
        ...
        # 3. Game Loop Start: Random Obstacle
        {
            ...
            "data": {
                "label": "장애물 등장",
                "attributes": [
                    {"key": "obs_type", "type": "number", "value": "rand.int(0, 1)"}, # 0: 선인장, 1: 익룡
                    {"key": "user_act", "type": "number", "value": "-1"}
                ]
            }
        },
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        **ui_top_bar(),
                        ...
                        # Logic: Show cactus or bird text
...
with open('/Users/max/lle 안티그래비티/new_1/공룡_런너_v1_인터랙티브.json', 'w', encoding='utf-8') as f:
    json.dump(dino_v1, f, ensure_ascii=False, indent=2)

print("공룡 런너 V1 생성 완료! 선택형 장애물 회피 시스템 및 고품격 UI 적용.")
