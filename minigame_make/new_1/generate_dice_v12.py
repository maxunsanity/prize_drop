...
dice_v12 = {
    ...
    "nodes": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t": {"type": "Text", "props": {"text": "🎲 주사위 v12 (Final Sync)", "variant": "title"}, "children": []},
        ...
        },
        {
            ...
            "data": {"label": "보상 허브", "sdtEffects": sdt()}
        },
        # THE FIX: Force the mockup to switch to the Result Scene at the end of logic
        {
            "id": "n_res_gold", "type": "resource",
            "position": {"x": 400, "y": 1050},
            "data": {
                "label": "골드 지급", 
                "resourceId": "res_gold", "resourceKey": "gold",
                "attributes": [{"key": "sim.activeScene", "type": "string", "value": "'n_end'"}]
            }
        },
        {
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "res_txt": {"type": "Text", "props": {"text": "획득 골드: {{money_gain}} G", "variant": "muted"}, "children": []},
    ...
    "edges": [
        ...
        {"id": "e7", "source": "n_gate_high", "target": "n_success", "type": "exec", "data": {"gateBranch": "true"}},
        {"id": "e8", "source": "n_gate_high", "target": "n_fail", "type": "exec", "data": {"gateBranch": "false"}},
        {"id": "e9", "source": "n_gate_low", "target": "n_success", "type": "exec", "data": {"gateBranch": "true"}},
        {"id": "e10", "source": "n_gate_low", "target": "n_fail", "type": "exec", "data": {"gateBranch": "false"}},
        {"id": "e11", "source": "n_success", "target": "n_reward_hub", "type": "exec"},
        {"id": "e12", "source": "n_reward_hub", "target": "n_res_gold", "type": "exec"},
        {"id": "e_res_flow", "source": "n_reward_hub", "target": "n_res_gold", "type": "resource", "data": {"resourceAmountExpression": "money_gain"}},
        {"id": "e13", "source": "n_res_gold", "target": "n_end", "type": "exec"},
        # FIXED: Fail path also needs to force scene update
        {"id": "e14", "source": "n_fail", "target": "n_end", "type": "exec", "data": {"onExec": {"action": "setState", "params": {"value": "n_end", "statePath": "/sim.activeScene"}}}}
    ]
}

with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v12_화면동기화보강.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v12, f, ensure_ascii=False, indent=2)

print("주사위 게임 V12 생성 완료! 결과 노드 진입 시 sim.activeScene 강제 업데이트 적용.")
