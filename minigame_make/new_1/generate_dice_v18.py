            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t": {"type": "Text", "props": {"text": "🎲 주사위 v18 (Resource)", "variant": "title"}, "children": []},
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "r2": {"type": "Text", "props": {"text": "남은 주사위: {{dice}} 개", "variant": "subtitle"}},
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v18_자원관리시스템.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v18, f, ensure_ascii=False, indent=2)

print("주사위 게임 V18 생성 완료! 주사위 수량(Dice Resource) 시스템 및 실시간 수량 검색 적용.")
