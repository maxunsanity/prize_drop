...
dice_v10 = {
    ...
    "nodes": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t": {"type": "Text", "props": {"text": "🎲 주사위 v10 (No Error)", "variant": "title"}, "children": []},
        ...
        # --- Logic nodes WITHOUT ternary operator ---
        {
    ...
    "edges": [
        ...
        {"id": "e12", "source": "n_reward_hub", "target": "n_res_gold", "type": "resource", "data": {"resourceAmountExpression": "money_gain"}},
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v10_게이트방식.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v10, f, ensure_ascii=False, indent=2)

print("주사위 게임 V10 생성 완료! 에러 유발 문자 '?' 제거 및 게이트 방식 적용.")
