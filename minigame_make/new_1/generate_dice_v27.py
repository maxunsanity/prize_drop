...
# IMPROVED: Edge-to-Edge Layout with Spacers
def ui_top_bar_edge():
    return {
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t2": {"type": "Text", "props": {"text": "더 넓고 시원해진 레이아웃", "variant": "subtitle"}},
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v27_양끝배치.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v27, f, ensure_ascii=False, indent=2)

print("주사위 게임 V27 생성 완료! 상단/하단 UI 양끝 배치(Edge-to-Edge) 적용.")
