...
game1 = {
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "title": {"type": "Text", "props": {"text": "🎲 주사위 v6 (완전 수동)", "variant": "title"}, "children": []},
                        "btn-start": {
    ...
    "edges": [
        ...
        # CRITICAL: NO EXEC EDGES from n-choice-scene to ensure manual jump only.
        # But for LLE validation, we keep them but make them rely on button jump.
        # If simulation still auto-execs, we might need a dummy wait node.
...
with open('/Users/max/lle 안티그래비티/new_1/게임1_주사위_홀짝_v6.json', 'w', encoding='utf-8') as f:
    json.dump(game1, f, ensure_ascii=False, indent=2)

print("V6 생성 완료! n-choice-scene에서 나가는 실선(exec) 제거로 수동 선택 강제.")
