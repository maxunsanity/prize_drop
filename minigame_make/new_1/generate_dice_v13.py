...
dice_v13 = {
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t": {"type": "Text", "props": {"text": "🎲 주사위 v13 (Result First)", "variant": "title"}, "children": []},
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "r": {"type": "Text", "props": {"text": "주사위: {{roll}}", "variant": "subtitle"}, "children": []},
                        "m": {"type": "Text", "props": {"text": "아쉽네요. 다음 기회에!", "variant": "muted"}, "children": []},
                        "sp": {"type": "Spacer", "props": {}, "children": []},
                        "btn": {"type": "Button", "props": {"label": "다시 하기", "variant": "secondary", "targetNodeId": "n_init"}, "children": []}
                    }
                }
            }
        },
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "b": {"type": "Button", "props": {"label": "한판 더!", "variant": "primary", "targetNodeId": "n_init"}, "children": []}
                    }
                }
            }
        }
    ...
    "edges": [
        ...
        # From Success Result to Reward Hub
        ...
        # From Fail Result to End or Restart
        {"id": "e14", "source": "n_show_fail", "target": "n_end", "type": "exec"}
    ]
}

with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v13_결과우선정산.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v13, f, ensure_ascii=False, indent=2)

print("주사위 게임 V13 생성 완료! 결과 화면 선 노출 후 보상 정산 방식 적용.")
