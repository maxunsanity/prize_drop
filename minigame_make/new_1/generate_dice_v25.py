...
dice_v25 = {
    ...
    "nodes": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t2": {"type": "Text", "props": {"text": "절대 에러 없는 완벽한 도전", "variant": "subtitle"}},
        ...
        # THE FIX: Bulletproof Initialization of ALL variables
        {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        **ui_top_bar(),
                        ...
                        "guide": {"type": "Text", "props": {"text": "💡 팁: 4~6은 높음, 1~3은 낮음입니다!", "variant": "muted"}},
                        "s2": {"type": "Spacer", "props": {}},
                        **ui_footer_status()
                    }
                }
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v25_철통초기화.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v25, f, ensure_ascii=False, indent=2)

print("주사위 게임 V25 생성 완료! 모든 변수 강제 초기화로 에러 완전 정복.")
