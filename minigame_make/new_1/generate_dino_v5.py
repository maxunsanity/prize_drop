...
game1_v5 = {
    ...
    "nodes": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "title": {"type": "Text", "props": {"text": "🦖 공룡 v5 (에러 수정 완료)", "variant": "title"}, "children": []},
        ...
        # ─── FIXED: Changed n-fail-gate from "gate" to "trigger" ───
        {
    ...
    "edges": [
        ...
        {"id": "e9", "source": "n-check-jump", "target": "n-fail-trigger", "type": "exec", "data": {"gateBranch": "false"}},
        {"id": "e10", "source": "n-check-duck", "target": "n-success-step", "type": "exec", "data": {"gateBranch": "true"}},
        {"id": "e11", "source": "n-check-duck", "target": "n-fail-trigger", "type": "exec", "data": {"gateBranch": "false"}},
        {"id": "e12", "source": "n-success-step", "target": "n-goal-gate", "type": "exec"},
        {"id": "e13", "source": "n-fail-trigger", "target": "n-calc-fail", "type": "exec"},
...
with open('/Users/max/lle 안티그래비티/new_1/게임1_구글_공룡_v5_최종수정.json', 'w', encoding='utf-8') as f:
    json.dump(game1_v5, f, ensure_ascii=False, indent=2)

print("공룡 달리기 V5 생성 완료! 실패 게이트 -> 트리거 노드로 변경 완료.")
