...
# Improved UI Elements with better spacing and visibility
def ui_top_bar():
    return {
        "top": {"type": "TopArea", "props": {}, "children": ["header_row"]},
        "header_row": {"type": "HStack", "props": {"spacing": 20}, "children": ["g_box", "d_box"]},
        "g_box": {"type": "HStack", "props": {"spacing": 4}, "children": ["g_icon", "g_val"]},
        "g_icon": {"type": "Icon", "props": {"name": "circle_dollar_sign", "color": "#FFD700"}},
        "g_val": {"type": "Text", "props": {"text": "{{gold}} G", "variant": "tabular"}},
        "d_box": {"type": "HStack", "props": {"spacing": 4}, "children": ["d_icon", "d_val"]},
        "d_icon": {"type": "Icon", "props": {"name": "dice_5", "color": "#FFFFFF"}},
        "d_val": {"type": "Text", "props": {"text": "{{dice}} EA", "variant": "tabular"}}
    }
...
def ui_footer_status():
    return {
        ...
        "f_row": {"type": "HStack", "props": {"spacing": 20}, "children": ["f_rate", "f_sp", "f_total"]},
        "f_rate": {"type": "Text", "props": {"text": "📊 누적 승률: {{win_rate}}%", "variant": "muted"}},
        "f_sp": {"type": "Spacer", "props": {}},
        "f_total": {"type": "Text", "props": {"text": "🏁 총 {{total_games}}회 플레이", "variant": "muted"}}
    }

dice_v24 = {
    "version": 1,
    "designName": "주사위_게임_v24_UI풀팩",
    "exportedAt": NOW,
    "resources": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t2": {"type": "Text", "props": {"text": "최고의 승부사가 되어보세요", "variant": "subtitle"}},
                        "s2": {"type": "Spacer", "props": {}},
                        "btn_grp": {"type": "VStack", "props": {"spacing": 16}, "children": ["b_enter"]},
                        "b_enter": {"type": "Button", "props": {"label": "🏰 게임 입장하기", "variant": "primary", "targetNodeId": "n_initial_setup"}},
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        **ui_top_bar(),
                        "body": {"type": "VStack", "props": {"spacing": 40}, "children": ["s1", "t_grp", "btns", "guide", "s2"]},
                        "s1": {"type": "Spacer", "props": {}},
                        "t_grp": {"type": "VStack", "props": {"spacing": 10}, "children": ["t", "st"]},
                        "t": {"type": "Text", "props": {"text": "주사위를 던지세요!", "variant": "title"}},
                        "st": {"type": "Text", "props": {"text": "다음 숫자는 높을까요, 낮을까요?", "variant": "subtitle"}},
                        "btns": {"type": "HStack", "props": {"spacing": 20}, "children": ["bh", "bl"]},
                        "bh": {"type": "Button", "props": {"label": "📈 높음 (4-6)", "variant": "primary", "targetNodeId": "n_high_calc"}},
                        "bl": {"type": "Button", "props": {"label": "📉 낮음 (1-3)", "variant": "secondary", "targetNodeId": "n_low_calc"}},
                        "guide": {"type": "Text", "props": {"text": "💡 팁: 높은 확률을 믿어보세요!", "variant": "muted"}},
                        "s2": {"type": "Spacer", "props": {}},
                        **ui_footer_status()
                    }
                }
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v24_UI풀팩.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v24, f, ensure_ascii=False, indent=2)

print("주사위 게임 V24 생성 완료! 수직 중앙 정렬 및 가독성 극대화 UI 적용.")
