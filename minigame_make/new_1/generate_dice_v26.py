...
MOCK_INIT = {
    ...
    "sdt": sdt(0, 50), # START WITH SOME MOTIVATION
    "sim.activeModal": "", "sim.activeScene": "", "sim.currentStep": 0, "sim.activeScreen": ""
}

# REVERTED TO CIRCULAR METERS (User Preferred)
def ui_top_bar_circular():
    return {
        "top": {"type": "TopArea", "props": {}, "children": ["header_row"]},
        "header_row": {"type": "HStack", "props": {"spacing": 20}, "children": ["m_gold", "m_dice"]},
...
dice_v26 = {
    ...
    "nodes": [
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t2": {"type": "Text", "props": {"text": "마찰 점수(SDT) 완벽 적용 버전", "variant": "subtitle"}},
        ...
        },
        {
            ...
            "data": {
                "label": "게임 로비",
                "motivation": 10, "competence": 5, "relatedness": 0, "autonomy": 5, # SDT Points
                "mockSpec": {
                    "root": "screen",
                    "elements": {
                        "screen": {"type": "Screen", "props": {}, "children": ["body"]},
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        **ui_top_bar_circular(), # CIRCULAR BACK!
                        ...
                        "guide": {"type": "Text", "props": {"text": "💡 팁: 높은 확률을 노려보세요!", "variant": "muted"}},
                        "s2": {"type": "Spacer", "props": {}},
                        **ui_footer_status()
                    }
                }
        ...
        },
        {
            ...
            "data": {
                "label": "승리",
                "motivation": 30, "competence": 20, # WIN BOOST
                "mockSpec": {
                    "root": "screen",
                    "elements": {
                        "screen": {"type": "Screen", "props": {}, "children": ["top", "body", "footer"]},
...
with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v26_SDT복구.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v26, f, ensure_ascii=False, indent=2)

print("주사위 게임 V26 생성 완료! SDT 마찰 점수 적용 및 원형 계기판(ResourceMeter) 복구.")
