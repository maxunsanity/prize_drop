...
dice_v11 = {
            ...
            "data": {
                ...
                "mockSpec": {
                    ...
                    "elements": {
                        ...
                        "t": {"type": "Text", "props": {"text": "🎲 주사위 v11 (Final)", "variant": "title"}, "children": []},
    ...
    "edges": [
        ...
        # FIXED: Explicit exec connection from Reward Hub to Resource to Success
        ...
        {"id": "e14", "source": "n_fail", "target": "n_end", "type": "exec"}
    ]
}

with open('/Users/max/lle 안티그래비티/new_1/주사위_게임_v11_최종안정화.json', 'w', encoding='utf-8') as f:
    json.dump(dice_v11, f, ensure_ascii=False, indent=2)

print("주사위 게임 V11 생성 완료! 보상 허브 -> 결과창 실행 경로(exec) 보강 완료.")
